...
import { GetAppointmentByIdUseCase } from "../../application/appointment/use-cases/get-appointment-by-id/GetAppointmentByIdUseCase";
...
const getAppointmentByIdUseCase = new GetAppointmentByIdUseCase(respository);
